...
(function(){
  ...
  async function render(container){
          ...
          <div class="card-body-mbms">
            <div class="table-responsive">
              <table class="table table-hover align-middle" id="piketTable" style="width:100%">
                <thead><tr><th style="width:48px">No</th><th>Tanggal</th><th>Area</th><th>Shift</th><th>Petugas</th><th>Status</th><th>Aksi</th></tr></thead>
                <tbody></tbody>
              </table>
            </div>
          </div>
    ...
    async function reload(){
      ...
      </tr>`).join("") || `<tr><td colspan="7" class="text-center text-muted py-4">Belum ada jadwal piket</td></tr>`;
      ...
      dt = $("#piketTable").DataTable({ pageLength:10, order:[], columnDefs:[TableUtil.numberColumnDef(0), {orderable:false,targets:[5,6]}], language:{search:"Cari:",zeroRecords:"Data tidak ditemukan"} });
    }
